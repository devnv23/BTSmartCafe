...
public class DeviceControlActivity extends Activity {
  ...
  //  private ExpandableListView mGattServicesList;
    ...
    public static final String Small_Coffee = "2";
    public static final String Medium_Coffee = "3";
    public static final String Large_Coffee = "4";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        vibe = (Vibrator)getSystemService(DeviceControlActivity.VIBRATOR_SERVICE);
    ...
    public void largecup (View view){
        ...
        vibe.vibrate(80);
        sendDataToBLE(Large_Coffee);


    }
    public void customcup (View view)
    {
//        customcup = (EditText)findViewById(R.id.textView1);
//        vibe.vibrate(80);
//
//        int val = Integer.parseInt(customcup.getText().toString());
//        String size =Integer.toString(val);
//        String size1= customcup.getText().toString();
//
//        sendDataToBLE(size1);
//
